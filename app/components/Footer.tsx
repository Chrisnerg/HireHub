...
const Footer = () => {
  return (
    <footer className="mt-16 border-t border-slate-300/70 bg-[#f7f6f2] text-slate-600">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 px-4 py-6 sm:flex-row sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-3 md:place-self-center md:justify-self-end">
          ...
          <a className="rounded-full border border-slate-300 p-2 transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-900" aria-label="YouTube">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
          ...
          <a className="rounded-full border border-slate-300 p-2 transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-900" aria-label="Facebook">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
